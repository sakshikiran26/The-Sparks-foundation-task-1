<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_individual.aspx.cs" Inherits="DBMS.TSF_BANK.view_individual" %>
...
<body style="background-color:lightgrey">
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" EmptyDataText="No Records Found"  ShowHeaderWhenEmpty="True"  HeaderStyle-BackColor="#3AC0F2" HeaderStyle-ForeColor="White" RowStyle-BackColor="#F8F4E3" AlternatingRowStyle-BackColor="White" RowStyle-ForeColor="#3A3A3A" AutoGenerateColumns="False" Height="182px" style="margin-bottom: 290px" Width="1413px" >
...
<RowStyle BackColor="#F8F4E3" ForeColor="#3A3A3A" HorizontalAlign="Center"></RowStyle>
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
              ...
              <asp:GridView ID="GridView2" runat="server" EmptyDataText="No Records Found"  ShowHeaderWhenEmpty="True"  HeaderStyle-BackColor="#3AC0F2" HeaderStyle-ForeColor="White" RowStyle-BackColor="#F8F4E3" AlternatingRowStyle-BackColor="White" RowStyle-ForeColor="#3A3A3A" AutoGenerateColumns="False" Height="296px"  style="margin-bottom: 290px" Width="1446px" >
<AlternatingRowStyle BackColor="White"></AlternatingRowStyle>
